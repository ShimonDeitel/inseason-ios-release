...
enum Reminders {
    private static let identifier = "inseason.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "What's fresh this week?"
        content.body = "Open Inseason to see peak seasonal produce for your market."
